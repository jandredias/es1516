...
public class DeleteFileTest extends TokenAccessTest {
	...
	protected void populate() {
		...
		try {
			...
			md.addDirectory("/home/teste1", "familia",
					teste1 /* , delete permissions */);
			md.getDirectory("/home/teste1/familia").setPermissions("-w-d-w-d");

			// //All delete permissions
			// md.addPlainFile("/home/teste1/familia", "mae", teste1, "mae"/* ,
			// delete permissions */);
			// md.getFile("/home/teste1/familia/mae").setPermissions("-w-d-w-d");

			// //None delete permissions
			// md.addPlainFile("/home/teste1/familia", "irma", teste1, "irma"/*
			// , without delete permissions */);
			// md.getFile("/home/teste1/familia/irma").setPermissions("-w---w--");

			// //No owner permissions
			// md.addPlainFile("/home/teste1/familia", "irmao", teste1,
			// "irmao"/* , without delete permissions */);
			// md.getFile("/home/teste1/familia/irmao").setPermissions("-w---w-d");

			// //Owner permissions
			// md.addPlainFile("/home/teste1/familia", "primo", teste1,
			// "primo"/* , without delete permissions */);
			// md.getFile("/home/teste1/familia/primo").setPermissions("-w-d-w--");

			// //Folder with write permissions and file with owner permissions
			// md.addDirectory("/home/teste1", "writePownerP", teste1 /* ,
			// without delete permissions */);
			// md.getDirectory("/home/teste1/writePownerP").setPermissions("-w-d-w--");
			// md.addPlainFile("/home/teste1/writePownerP", "ownerP", teste1,
			// "ownerP"/* , without delete permissions */);
			// md.getFile("/home/teste1/writePownerP/ownerP").setPermissions("-w-d-w--");
			//
			// //Folder with write permissions and file with no owner
			// permissions
			// md.addDirectory("/home/teste1", "writePNoownerP", teste1 /* ,
			// without delete permissions */);
			// md.getDirectory("/home/teste1/writePNoownerP").setPermissions("-w-d-w--");
			// md.addPlainFile("/home/teste1/writePNoownerP", "NoownerP",
			// teste1, "NoownerP"/* , without delete permissions */);
	...
	public void DeleteFileOwner() throws MyDriveException {
		...
		long t9999 = md.getValidToken("teste1", "/home/teste1/familia", new StrictlyTestObject());
		// Owner permissions
		md.addPlainFile("/home/teste1/familia", "file", teste1,
				"file"/* , without delete permissions */);
	...
	public void DeleteFileOwnerNoPermissions() throws MyDriveException {
		...
		long t9999 = md.getValidToken("teste1", "/home/teste1/familia", new StrictlyTestObject());
		// None delete permissions
		md.addPlainFile("/home/teste1/familia", "irma", teste1,
	...
	public void DeleteDirectoryWithoutPermissions() throws MyDriveException {
		...
		md.addDirectory("/home/teste1", "file",
				teste1 /* , without delete permissions */);
		md.getDirectory("/home/teste1/file").setPermissions("---d----");
	...
	public void DeleteDirectoryOwnerPermissionsWithExecute() throws MyDriveException {
		...
		md.addDirectory("/home/teste1", "dir",
				teste1 /* , without delete permissions */);
		...
		md.addPlainFile("/home/teste1/dir", "file", teste1,
				"ownerP"/* , without delete permissions */);
