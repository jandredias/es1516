...
public static void teste_tiago(){
	...
	Directory rootDir = md.getRootDirectory();
	User rootUsr = md.getRootUser();
	Directory olaDir = new Directory("ola12345678", md.getFileId(), new DateTime(), 11111010, rootUsr, rootDir);
	md.incrementFileId();
	PlainFile file = new PlainFile("README", md.getFileId(), new DateTime(), 11111011, rootUsr, "cenas");
	...
	Directory olaDir1 = new Directory("ola12345678", md.getFileId(), new DateTime(), 11111010, rootUsr, rootDir);
	try{
